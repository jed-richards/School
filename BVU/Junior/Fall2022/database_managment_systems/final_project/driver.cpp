...
void runSimpleSelectQuery() {
  ...
  */
  Select op1("bigData/students.data", "S_GPA",">","3.0");
  //Select op2("smallData/student.data", "S_dept_name","=","Comp. Sci.");
  //Select op1(&op2, "S_tot_cred",">", "50");
...
void runTest() {
  ...
  Select  op3("bigData/students.data", "S_Year","=","Sr");
  Select  op2(&op3, "S_GPA",">", "3.5");
  //Select  op4("bigData/departments.data", "D_DepartmentName","=","Computer Science");
  Project op1(&op2, {"S_FirstName", "S_LastName", "S_Year", "S_GPA"});
